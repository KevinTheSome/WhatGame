...
class gamesController extends Controller
{
    ...
    public function addToFavourites(Request $request) {
        try {
            ...
            if(Game::where('game_id', $request->game_id)->where('user_id', $request->user()->id)->exists()) {
                Game::where('game_id', $request->game_id)->where('user_id', $request->user()->id)->delete();
            }else{
                Game::create([
            ...
            return response()->json(['error' => 'Failed to set game as favourite', 'errorMessage' => $th->getMessage()], 500);
        }
    ...
    public function getUserFavourites(Request $request) {
        try {
            ...
            if(!isset($request->user_id)){
                $favourites = Game::where('user_id', $request->user()->id)->get();
            ...
            return response()->json(['error' => 'Failed to get favorited games', 'errorMessage' => $th->getMessage()], 500);
        }
